...
<!--                </select>-->
    ...
    export default {
      ...
      setup({emit}) {
        ...
        return { user, selectedSession,selectedSessionId,messageContent, sessions,isSending,selectedModel,selecteresponse,selectSession,createNewSession ,sendMessage,handleKeydown,adjustTextareaHeight,handleDelete,handleRename };
      }
    };
